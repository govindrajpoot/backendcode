...
//     if (req.query.length) {
//       filter['dimensions.length'] = parseFloat(req.query.length);
//     }
//     if (req.query.width) {
//       filter['dimensions.width'] = parseFloat(req.query.width);
//     }
//     if (req.query.height) {
//       filter['dimensions.height'] = parseFloat(req.query.height);
//     }
